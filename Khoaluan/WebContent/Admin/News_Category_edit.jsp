					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form action="/Khoaluan/News_Category_Servlet_Update" method="post">
										
											<div class="form-group">
												<label>Tên loại tin</label> 
												<span style="color: red"><%=tendanhmuc_error %></span>
												 <textarea rows="20" cols="20" id="editor" name="Name_News_Category"  ><%=request.getParameter("Name_News_Category") %></textarea>
											</div>
											
											<input type="hidden" name="action" value="Update"> 
											<input type="hidden" name="ID_News_Category" value="<%=request.getParameter("ID_News_Category")%>"> 				
											...
											<a href="News_Category_manager.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>	
										</form>
										<br />
									</div>
								</div>
