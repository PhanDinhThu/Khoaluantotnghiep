					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/Khoaluan/Admin/inventory_manager.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Quay lại</a>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background:#106356; color:black; font-weight:bold">Sản phẩm đã xuất kho
