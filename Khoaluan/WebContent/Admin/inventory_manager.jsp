					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/Khoaluan/Admin/product_export.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Sản Phẩm Đã Xuất Kho</a>
						</div>
					</div>
				</div>
				<hr />
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="font-weight:bold; background:#106356; color:black;">QUẢN LÝ TỒN KHO</div>
									...
									<table class="table table-striped table-bordered table-hover table2excel kkk1"
										...
										<%
											...
											%>
												...
												%>									
												<a class="btn btn-primary btn-xs">Gần hết hàng</a>			
												<%
													}
												%>
												<% 
												...
												%>									
												<a class="btn btn-danger btn-xs">Đã hết hàng</a>			
												<%
													}
												%></td>
