				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading"  style="background:#106356; color:black; font-weight:bold">Thêm Danh Mục</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/Khoaluan/CategoryServlet_Add" method="post">
											...
											<div class="form-group">
												<label>Tên danh mục</label> 
												 <textarea rows="20" cols="20" id="editor" class="form-control" name="Name_Category"  value="<%=tendanhmuc%>"></textarea>										
											...
											<a href="/Khoaluan/Admin/category_manager.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>	
										</form>
										<br />
									</div>
								</div>
