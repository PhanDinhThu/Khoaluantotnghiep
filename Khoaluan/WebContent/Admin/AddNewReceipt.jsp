	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>QUẢN LÝ QUẢN LÝ NHẬP HÀNG</h2>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="background:#106356; color:black; font-weight:bold">Thêm Mới Sản Phẩm</div>
								...
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/Khoaluan/ReceiptDetailServlet_AddNew" method="post" enctype="multipart/form-data">
										    ...
										    <a href="/Khoaluan/Admin/GoodReceipt.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>
										</form>
										<br />
									</div>
								</div>
