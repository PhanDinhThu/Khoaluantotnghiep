					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/Khoaluan/Admin/season_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm mùa sự kiện</a>
						</div>
					</div>
				</div>
				<hr />
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background:#106356; color:black; font-weight:bold">QUẢN LÝ MÙA SỰ KIỆN</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<%
											...
											<tr class="odd gradeX">
												...
												<td class="center" style="text-align:center"><a href="/Khoaluan/Admin/season_edit.jsp?action=Update&ID_Season=<%=cate.getID_Season()%>&Name_Season=<%=cate.getName_Season()%>&DateStart=<%=cate.getDateStart()%>&DateEnd=<%=cate.getDateEnd()%>"
												...
												%>  href="/Khoaluan/SeasonServlet_Delete?action=Delete&ID_Season=<%=cate.getID_Season()%>" onclick="return confirm('Bạn có chắc chắn xóa sự kiện <%=cate.getName_Season() %> không ?')"
