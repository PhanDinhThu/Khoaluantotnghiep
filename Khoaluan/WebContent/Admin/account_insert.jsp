				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="background:#106356; color:black; font-weight:bold">Thêm Tài Khoản</div>
									...
									<div class="col-md-6">
										<form role="form" action="/Khoaluan/AccountServlet_Add_Del" method="post">
											...
											<button type="reset" class="btn btn-primary" style="margin-left:5%">Khôi phục</button>
												<a href="/Khoaluan/Admin/account_manager.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>	
										</form>
										<br />
									</div>
								</div>
