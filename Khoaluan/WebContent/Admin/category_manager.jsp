					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/Khoaluan/Admin/category_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm danh mục</a>
						</div>
					</div>
				</div>
				<hr />
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background:#106356; color:black; font-weight:bold">QUẢN LÝ DANH MỤC</div>
										...
										<%
											...
											<tr class="odd gradeX">
												...
												<td style="text-align:center"><%=cate.getName_Category()%></td>
												 ...
												 <span><a href="/Khoaluan/Admin/category_edit.jsp?action=Update&ID_Category=<%=cate.getID_Category()%>&Name_Category=<%=cate.getName_Category()%>"
												...
												%>  href="/Khoaluan/CategoryServlet_Delete?action=Delete&ID_Category=<%=cate.getID_Category()%>" onclick="return confirm('Bạn có chắc chắn xóa danh mục <%=cate.getName_Category() %> không ?')"
